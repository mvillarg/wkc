    ...
    function create_each_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = text(t1_value);
    			t2 = text("  ");
    			attr_dev(span, "class", "non-capital svelte-1qscbh4");
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t0 = text(t0_value);
    			t1 = text("  ");
    			attr_dev(h1, "class", "svelte-1qscbh4");
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "full-text svelte-1qscbh4");
    			add_location(h1, file, 15, 0, 368);
    			attr_dev(div, "class", "brief-text svelte-1qscbh4");
